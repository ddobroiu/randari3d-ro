...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const predictionRes = await fetch("https://api.replicate.com/v1/predictions", {
      ...
      body: JSON.stringify({
        version: "0a1381936934845a14efcc9f309ce7d031cb905867878b5c5830280e00e97606", // același model
        input: {
    ...
    await prisma.history.create({
      data: {
        ...
        imageUrl: output,
        prompt: prompt,
        robot: "image-image", // doar eticheta diferă
        pointsUsed: 10, // sau 5, dacă vrei să coste mai puțin
      },
    });
